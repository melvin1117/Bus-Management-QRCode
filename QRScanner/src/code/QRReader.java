...
public class QRReader extends JPanel implements java.beans.PropertyChangeListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		//	String url="http://localhost:82/iclub/qr.php?bus=11";
			webLaunch wbl = new webLaunch(s.data);
			...
			/*try {
		         ...
		         java.awt.Desktop.getDesktop().browse(java.net.URI.create(s.data));
		         f.setVisible(true);
		        f.isActive();
		        f.toFront();
		      f.requestFocus();
